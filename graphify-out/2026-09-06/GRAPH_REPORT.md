...
## Corpus Check
- 44 files · ~16,611 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 282 nodes · 440 edges · 24 communities (14 shown, 7 thin omitted)
...
2. `FileRoutesByPath` - 18 edges
3. `formatRelative()` - 10 edges
4. `relations` - 9 edges
...
- `RouteComponent()` --calls--> `formatRelative()`  [EXTRACTED]
  src/routes/_protected/dashboard.tsx → src/lib/format.ts
...
Cohesion: 0.09
Nodes (29): DateInput, formatCreatedAt, formatDate(), formatDateShort(), formatDateTime(), formatRelative(), formatUpdatedAt(), toDate() (+21 more)
...
### Community 17 - "FileRoutesByPath"
Cohesion: 0.35
Nodes (6): ensureSession, getSession, Route, Route, Route, FileRoutesByPath
...
## Knowledge Gaps
- **113 isolated node(s):** `name`, `module`, `type`, `private`, `dev` (+108 more)
